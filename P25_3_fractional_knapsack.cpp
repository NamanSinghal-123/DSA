...
#include<bits/stdc++.h>
using namespace std;
//Greedy about only weight no matter bag will be full or not, we just want to collect as many items as we can.
int main(){
    int len;
    ...
    // cout<<"The remaining weight is:"<<max_weight<<endl;
    return 0;
}